...
python3 test.py \
  ...
  --dataroot=./data/GAN-dataset-complete-clipped-shifted-real \
  --dataset=test \
  --tag=d2_multiview2500-real-test \
  --data=data/chengsq/AECT-GAN/model_dic/MultiView-AECT-GAN \
  --dataset_class=align_ct_xray_views_std \
  --model_class=MultiView-AECT-GAN \
  --datasetfile=./data/real_test.txt \
...
python3 test.py \
  ...
  --dataroot=./data/GAN-dataset-complete-clipped-shifted-real \
  --dataset=test \
  --tag=multiview-GAN-dataset-complete-clipped-shifted-real-test \
  --data=data/chengsq/AECT-GAN/model_dic/MultiView-AECT-GAN \
  --dataset_class=align_ct_xray_views_std \
  --model_class=MultiView-AECT-GAN \
  --datasetfile=./data/real_test.txt \
...
python3 test.py \
  ...
  --dataroot=./data/GAN-dataset-complete-clipped-shifted-real \
  --dataset=test \
  --tag=multiview-GAN-dataset-complete-clipped-shifted-real_mixed-real-test \
  --data=data/chengsq/AECT-GAN/model_dic/MultiView-AECT-GAN \
  --dataset_class=align_ct_xray_views_std \
  --model_class=MultiView-AECT-GAN \
  --datasetfile=./data/real_test.txt \
